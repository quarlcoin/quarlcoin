...
Quarlcoin. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring Quarlcoin

**When configuring Quarlcoin, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Quarlcoin:
...
variables will be set when generating the Quarlcoin buildsystem. In this case, `-DENABLE_WALLET=OFF`.
