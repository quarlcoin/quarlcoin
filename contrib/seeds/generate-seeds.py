...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('// Copyright (c) 2026 The Quarlcoin developers\n')
    g.write('// See COPYING for license.\n\n')
    g.write('#ifndef QUARLCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define QUARLCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the quarlcoin network\n')
    ...
    g.write('#endif // QUARLCOIN_CHAINPARAMSSEEDS_H\n')
