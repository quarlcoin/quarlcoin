...
complete --command quarld --no-files

# Extract options
function __fish_quarld_get_options
...
complete \
    --command quarld \
    --arguments "(__fish_quarld_get_options --nofiles)"
