...
complete --command quarl-qt --no-files

# Extract options
function __fish_quarlcoinqt_get_options
...
complete \
    --command quarl-qt \
    --arguments "(__fish_quarlcoinqt_get_options)"
...
complete \
    --command quarl-qt \
    --arguments "(__fish_quarlcoinqt_get_options --nofiles)"
