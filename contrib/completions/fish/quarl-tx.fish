...
# Extract options
function __fish_quarlcoin_tx_get_options
...
# Extract commands
function __fish_quarlcoin_tx_get_commands
...
complete \
    --command quarl-tx \
    --condition "not __fish_quarlcoin_seen_cmd (__fish_quarlcoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_quarlcoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command quarl-tx \
    --arguments "(__fish_quarlcoin_tx_get_commands)" \
    --no-files
