# Copyright (c) 2025-present The Quarlcoin developers
...
function(extract_strings output)
  ...
  file(STRINGS "quarlcoinstrings.po" text ENCODING "UTF-8")
...
static const char UNUSED *quarlcoin_strings[] = {
  ...
  set(prefix "QT_TRANSLATE_NOOP(\"quarlcoin-core\", \"")
  set(suffix "\"),\n")
...
extract_strings("${PROJECT_SOURCE_DIR}/src/qt/quarlcoinstrings.cpp"
...
execute_process(
  COMMAND ${LUPDATE_EXECUTABLE}
    ...
    ${PROJECT_SOURCE_DIR}/src/qt/quarlcoinstrings.cpp
    -ts ${PROJECT_SOURCE_DIR}/src/qt/locale/quarlcoin_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)
...
execute_process(
  COMMAND ${LCONVERT_EXECUTABLE}
    -drop-translations
    -o ${PROJECT_SOURCE_DIR}/src/qt/locale/quarlcoin_en.xlf
    -i ${PROJECT_SOURCE_DIR}/src/qt/locale/quarlcoin_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)

file(READ "${PROJECT_SOURCE_DIR}/src/qt/locale/quarlcoin_en.xlf" quarlcoin_en)
string(REPLACE "source-language=\"en\" target-language=\"en\""
  "source-language=\"en\"" quarlcoin_en "${quarlcoin_en}"
)
string(REGEX REPLACE " *<target xml:space=\"preserve\"></target>\n"
  "" quarlcoin_en "${quarlcoin_en}"
)
file(WRITE "${PROJECT_SOURCE_DIR}/src/qt/locale/quarlcoin_en.xlf" "${quarlcoin_en}")
