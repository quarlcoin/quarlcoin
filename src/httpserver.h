...
#ifndef QUARLCOIN_HTTPSERVER_H
#define QUARLCOIN_HTTPSERVER_H
...
namespace http_quarlcoin {
    class HTTPRequest;
}
/** Handler for requests to a certain HTTP path */
using HTTPRequestHandler = std::function<void(http_quarlcoin::HTTPRequest* req, const std::string&)>;
