...
#ifndef QUARLCOIN_VERSIONBITS_IMPL_H
#define QUARLCOIN_VERSIONBITS_IMPL_H
...
protected:
    ...
    int Period() const override { return dep.signalling_period; }
...
#endif // QUARLCOIN_VERSIONBITS_IMPL_H
