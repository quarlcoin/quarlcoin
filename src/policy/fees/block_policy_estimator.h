...
#ifndef QUARLCOIN_POLICY_FEES_BLOCK_POLICY_ESTIMATOR_H
#define QUARLCOIN_POLICY_FEES_BLOCK_POLICY_ESTIMATOR_H
...
#endif // QUARLCOIN_POLICY_FEES_BLOCK_POLICY_ESTIMATOR_H
