...
#ifndef QUARLCOIN_POLICY_FEERATE_H
#define QUARLCOIN_POLICY_FEERATE_H
...
public:
    ...
    std::string ToString(FeeRateFormat fee_rate_format = FeeRateFormat::RNT_KVB) const;
...
#endif // QUARLCOIN_POLICY_FEERATE_H
