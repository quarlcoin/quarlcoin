...
using http_quarlcoin::InitHTTPServer;
using http_quarlcoin::InterruptHTTPServer;
using http_quarlcoin::StartHTTPServer;
using http_quarlcoin::StopHTTPServer;
 ...
 */
static const char* QUARLCOIN_PID_FILENAME = "quarld.pid";
/**
...
{
    return AbsPathForConfigVal(args, args.GetPathArg("-pid", QUARLCOIN_PID_FILENAME));
}
...
void SetupServerArgs(ArgsManager& argsman, bool can_listen_ipc)
{
    ...
    argsman.AddArg("-persistmempoolv1",
                   ...
                   ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
    argsman.AddArg("-pid=<file>", strprintf("Specify pid file. Relative paths will be prefixed by a net-specific datadir location. (default: %s)", QUARLCOIN_PID_FILENAME), ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
