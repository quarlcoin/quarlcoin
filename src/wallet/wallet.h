...
#ifndef QUARLCOIN_WALLET_WALLET_H
#define QUARLCOIN_WALLET_WALLET_H
...
public:
     ...
     * quarl-wallet tool code or by wallet migration code. If this is called
...
#endif // QUARLCOIN_WALLET_WALLET_H
