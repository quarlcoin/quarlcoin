...
#ifndef QUARLCOIN_WALLET_WALLETUTIL_H
#define QUARLCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! quarlcoin from opening the wallet, thinking it was newly created, and
...
#endif // QUARLCOIN_WALLET_WALLETUTIL_H
