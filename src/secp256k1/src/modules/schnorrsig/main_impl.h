...
static void secp256k1_nonce_function_bip340_sha256_tagged(secp256k1_hash256 *sha) {
    static const unsigned char tag[] = "BIP0340/nonce";
    secp256k1_hash256_initialize_tagged(sha, tag, sizeof(tag) - 1);
}

/* Initializes SHA256 with fixed midstate. This midstate was computed by applying
 * SHA256 to SHA256("BIP0340/aux")||SHA256("BIP0340/aux"). */
static void secp256k1_nonce_function_bip340_sha256_tagged_aux(secp256k1_hash256 *sha) {
    static const unsigned char tag[] = "BIP0340/aux";
    secp256k1_hash256_initialize_tagged(sha, tag, sizeof(tag) - 1);
}
...
static int nonce_function_bip340(unsigned char *nonce32, const unsigned char *msg, size_t msglen, const unsigned char *key32, const unsigned char *xonly_pk32, const unsigned char *algo, size_t algolen, void *data) {
    ...
    if (data != NULL) {
        ...
        secp256k1_hash256_write(&sha, data, 32);
        secp256k1_hash256_finalize(&sha, masked_key);
        for (i = 0; i < 32; i++) {
    ...
    if (algolen == sizeof(bip340_algo)
        ...
        secp256k1_hash256_initialize_tagged(&sha, algo, algolen);
    }

    /* Hash masked-key||pk||msg using the tagged hash as per the spec */
    secp256k1_hash256_write(&sha, masked_key, 32);
    secp256k1_hash256_write(&sha, xonly_pk32, 32);
    secp256k1_hash256_write(&sha, msg, msglen);
    secp256k1_hash256_finalize(&sha, nonce32);
...
static void secp256k1_schnorrsig_sha256_tagged(secp256k1_hash256 *sha) {
...
static void secp256k1_schnorrsig_challenge(secp256k1_scalar* e, const unsigned char *r32, const unsigned char *msg, size_t msglen, const unsigned char *pubkey32)
{
    ...
    secp256k1_hash256_write(&sha, r32, 32);
    secp256k1_hash256_write(&sha, pubkey32, 32);
    secp256k1_hash256_write(&sha, msg, msglen);
    secp256k1_hash256_finalize(&sha, buf);
