 ...
 *
 * Hashed with SHA3-256, which is the odd one out in this tree: everything the
 * chain hashes is SHA-256. It stays because Keccak is compiled in regardless --
 * the Tor v3 checksum below is specified as SHA3-256 -- and because the digest
 * here only has to be stable with itself, never with anything a peer computes.
 */
