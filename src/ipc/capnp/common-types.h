...
#ifndef QUARLCOIN_IPC_CAPNP_COMMON_TYPES_H
#define QUARLCOIN_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between quarlcoin processes.
...
//! Functions to serialize / deserialize common quarlcoin types.
namespace mp {
...
#endif // QUARLCOIN_IPC_CAPNP_COMMON_TYPES_H
