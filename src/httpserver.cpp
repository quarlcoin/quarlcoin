...
using http_quarlcoin::HTTPRequest;
...
static std::unique_ptr<http_quarlcoin::HTTPServer> g_http_server{nullptr};
...
static void RejectRequest(std::unique_ptr<http_quarlcoin::HTTPRequest> hreq)
{
