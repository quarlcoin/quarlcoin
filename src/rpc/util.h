...
#ifndef QUARLCOIN_RPC_UTIL_H
#define QUARLCOIN_RPC_UTIL_H
...
/**
 * Parse a json number or string, denoting QRL/kvB, into a CFeeRate (sat/kvB).
...
/** Quarlcoin spells it RPCMethod. Same class: the alias exists so the RPCs
 *  written here and the ones ported from Core can sit in one tree. */
using RPCMethod = RPCHelpMan;
