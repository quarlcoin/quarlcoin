 ...
 * for both quarld and quarl-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string UA_NAME("Quarlcoin");


#include <quarlcoin-build-info.h>
// The <quarlcoin-build-info.h>, which is generated by the build environment,
