...
#ifndef QUARLCOIN_NODE_CONTEXT_H
#define QUARLCOIN_NODE_CONTEXT_H
...
struct NodeContext {
    ...
    //! secp256k1's signing context. Nothing that signs or derives a public key
    //! works before this exists, which the post-quantum scheme this replaced did
    //! not need and so nobody created.
...
#endif // QUARLCOIN_NODE_CONTEXT_H