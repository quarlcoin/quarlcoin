...
#include <algorithm>
#include <attributes.h> // Added for Quarlcoin
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Quarlcoin
#include <util/string.h> // Added for Quarlcoin
...
// Added for Quarlcoin. Similar to std::runtime_format from C++26.
...
// Added for Quarlcoin. Wrapper for checking format strings at compile time.
