...
#ifndef QUARLCOIN_SCRIPT_INTERPRETER_H
#define QUARLCOIN_SCRIPT_INTERPRETER_H
...
struct PrecomputedTransactionData
{
    ...
    // These are single-SHA256, see https://github.com/quarlcoin/bips/blob/master/bip-0341.mediawiki#cite_note-16.
...
extern const SHA256Writer HASHER_TAPSIGHASH; //!< Hasher with tag "TapSighash" pre-fed to it.
extern const SHA256Writer HASHER_TAPLEAF;    //!< Hasher with tag "TapLeaf" pre-fed to it.
extern const SHA256Writer HASHER_TAPBRANCH;  //!< Hasher with tag "TapBranch" pre-fed to it.
...
#endif // QUARLCOIN_SCRIPT_INTERPRETER_H
