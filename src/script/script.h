...
#ifndef QUARLCOIN_SCRIPT_SCRIPT_H
#define QUARLCOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Quarlcoin always counted CHECKMULTISIGs
...
#endif // QUARLCOIN_SCRIPT_SCRIPT_H
