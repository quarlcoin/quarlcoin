...
#ifndef QUARLCOIN_CLIENTVERSION_H
#define QUARLCOIN_CLIENTVERSION_H
...
#error Client version information missing: version is not defined by quarlcoin-build-config.h or in any other way
#endif
...
#endif // QUARLCOIN_CLIENTVERSION_H
