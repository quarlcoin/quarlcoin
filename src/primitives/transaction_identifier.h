...
#ifndef QUARLCOIN_PRIMITIVES_TRANSACTION_IDENTIFIER_H
#define QUARLCOIN_PRIMITIVES_TRANSACTION_IDENTIFIER_H
...
#endif // QUARLCOIN_PRIMITIVES_TRANSACTION_IDENTIFIER_H
