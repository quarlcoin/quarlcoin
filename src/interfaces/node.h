...
#ifndef QUARLCOIN_INTERFACES_NODE_H
#define QUARLCOIN_INTERFACES_NODE_H
...
public:
    ...
    using MessageBoxFn = std::function<bool(const bilingual_str& message, unsigned int style)>;
...
#endif // QUARLCOIN_INTERFACES_NODE_H