...
#ifndef QUARLCOIN_INTERFACES_INIT_H
#define QUARLCOIN_INTERFACES_INIT_H
...
//! (quarlcoin-gui, quarlcoin-node, quarl-wallet, quarld, quarl-qt) and each
...
#endif // QUARLCOIN_INTERFACES_INIT_H
