...
#ifndef QUARLCOIN_KERNEL_DISCONNECTED_TRANSACTIONS_H
#define QUARLCOIN_KERNEL_DISCONNECTED_TRANSACTIONS_H
...
#endif // QUARLCOIN_KERNEL_DISCONNECTED_TRANSACTIONS_H
