    ...
    if (all_from_me || !any_from_me) {
        ...
        for(unsigned int i = 0; i < wtx.tx->vout.size(); i++)
        {
            ...
            if (all_from_me) {
                ...
                // Otherwise, someone just sent quarlcoins to a change address, which should be shown
                ...
                else
                {
                    ...
                    sub.address = wtx.value_map.contains("to") ? wtx.value_map.at("to") : std::string{};
                }
            ...
            if(mine)
            {
                ...
                else
                {
                    ...
                    sub.address = wtx.value_map.contains("from") ? wtx.value_map.at("from") : std::string{};
                }
                if (wtx.is_coinbase)
                {
                    // Generated
