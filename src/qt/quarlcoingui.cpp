 ...
 *
 * Ref: https://github.com/quarlcoin/quarlcoin/pull/1026
 */
static constexpr int64_t MAX_BLOCK_TIME_GAP = 90 * 60;

const std::string QuarlcoinGUI::DEFAULT_UIPLATFORM =
...
QuarlcoinGUI::QuarlcoinGUI(interfaces::Node& node, const PlatformStyle *_platformStyle, const NetworkStyle *networkStyle, QWidget *parent) :
    QMainWindow(parent),
    m_node(node),
    ...
    m_network_style(networkStyle)
{
    ...
    if(enableWallet)
    {
        ...
        connect(walletFrame, &WalletFrame::createWalletButtonClicked, this, &QuarlcoinGUI::createWallet);
    ...
    connect(labelBlocksIcon, &GUIUtil::ClickableLabel::clicked, this, &QuarlcoinGUI::showModalOverlay);
    connect(progressBar, &GUIUtil::ClickableProgressBar::clicked, this, &QuarlcoinGUI::showModalOverlay);
...
void QuarlcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Quarlcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and quarlcoin: URIs)"));
    ...
    connect(overviewAction, &QAction::triggered, this, &QuarlcoinGUI::gotoOverviewPage);
    connect(sendCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(sendCoinsAction, &QAction::triggered, [this]{ gotoSendCoinsPage(); });
    connect(receiveCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(receiveCoinsAction, &QAction::triggered, this, &QuarlcoinGUI::gotoReceiveCoinsPage);
    connect(historyAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(historyAction, &QAction::triggered, this, &QuarlcoinGUI::gotoHistoryPage);
#endif // ENABLE_WALLET
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Quarlcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message…"), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Quarlcoin addresses"));
    m_load_psbt_action = new QAction(tr("&Load PSBT from file…"), this);
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed Quarlcoin Transaction"));
    m_load_psbt_clipboard_action = new QAction(tr("Load PSBT from &clipboard…"), this);
    m_load_psbt_clipboard_action->setStatusTip(tr("Load Partially Signed Quarlcoin Transaction from clipboard"));
    ...
    openAction->setStatusTip(tr("Open a quarlcoin: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Quarlcoin command-line options").arg(CLIENT_NAME));
    ...
    connect(quitAction, &QAction::triggered, this, &QuarlcoinGUI::quitRequested);
    connect(aboutAction, &QAction::triggered, this, &QuarlcoinGUI::aboutClicked);
    connect(aboutQtAction, &QAction::triggered, qApp, QApplication::aboutQt);
    connect(optionsAction, &QAction::triggered, this, &QuarlcoinGUI::optionsClicked);
    connect(showHelpMessageAction, &QAction::triggered, this, &QuarlcoinGUI::showHelpMessageClicked);
    connect(openRPCConsoleAction, &QAction::triggered, this, &QuarlcoinGUI::showDebugWindow);
    ...
    if(walletFrame)
    {
        ...
        connect(openAction, &QAction::triggered, this, &QuarlcoinGUI::openClicked);
        connect(m_open_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const auto& [path, info] : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, path] {
                    ...
                    connect(activity, &OpenWalletActivity::opened, this, &QuarlcoinGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_restore_wallet_action, &QAction::triggered, [this] {
            ...
            connect(activity, &RestoreWalletActivity::restored, this, &QuarlcoinGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_create_wallet_action, &QAction::triggered, this, &QuarlcoinGUI::createWallet);
        ...
        connect(m_migrate_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const auto& [wallet_name, info] : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, wallet_name] {
                    ...
                    connect(activity, &MigrateWalletActivity::migrated, this, &QuarlcoinGUI::setCurrentWallet);
        ...
        connect(m_mask_values_action, &QAction::toggled, this, &QuarlcoinGUI::setPrivacy);
        connect(m_mask_values_action, &QAction::toggled, this, &QuarlcoinGUI::enableHistoryAction);
    }
#endif // ENABLE_WALLET

    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_C), this), &QShortcut::activated, this, &QuarlcoinGUI::showDebugWindowActivateConsole);
    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_D), this), &QShortcut::activated, this, &QuarlcoinGUI::showDebugWindow);
}

void QuarlcoinGUI::createMenuBar()
{
    appMenuBar = menuBar();
...
void QuarlcoinGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        connect(m_wallet_selector, qOverload<int>(&QComboBox::currentIndexChanged), this, &QuarlcoinGUI::setCurrentWalletBySelectorIndex);
...
void QuarlcoinGUI::setClientModel(ClientModel *_clientModel, interfaces::BlockAndHeaderTipInfo* tip_info)
{
    ...
    if(_clientModel)
    {
        ...
        connect(_clientModel, &ClientModel::numConnectionsChanged, this, &QuarlcoinGUI::setNumConnections);
        connect(_clientModel, &ClientModel::networkActiveChanged, this, &QuarlcoinGUI::setNetworkActive);
        ...
        connect(_clientModel, &ClientModel::numBlocksChanged, this, &QuarlcoinGUI::setNumBlocks);
        ...
        connect(_clientModel, &ClientModel::showProgress, this, &QuarlcoinGUI::showProgress);
...
#ifdef ENABLE_WALLET
void QuarlcoinGUI::enableHistoryAction(bool privacy)
{
...
void QuarlcoinGUI::setWalletController(WalletController* wallet_controller, bool show_loading_minimized)
{
    ...
    GUIUtil::ExceptionSafeConnect(wallet_controller, &WalletController::walletAdded, this, &QuarlcoinGUI::addWallet);
    connect(wallet_controller, &WalletController::walletRemoved, this, &QuarlcoinGUI::removeWallet);
...
WalletController* QuarlcoinGUI::getWalletController()
{
    return m_wallet_controller;
}

void QuarlcoinGUI::addWallet(WalletModel* walletModel)
{
    ...
    connect(wallet_view, &WalletView::outOfSyncWarningClicked, this, &QuarlcoinGUI::showModalOverlay);
    connect(wallet_view, &WalletView::transactionClicked, this, &QuarlcoinGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::coinsSent, this, &QuarlcoinGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        this->message(title, message, style);
    });
    connect(wallet_view, &WalletView::encryptionStatusChanged, this, &QuarlcoinGUI::updateWalletStatus);
    connect(wallet_view, &WalletView::incomingTransaction, this, &QuarlcoinGUI::incomingTransaction);
    connect(this, &QuarlcoinGUI::setPrivacy, wallet_view, &WalletView::setPrivacy);
    wallet_view->setPrivacy(isPrivacyModeActivated());
    const QString display_name = walletModel->getDisplayName();
    m_wallet_selector->addItem(display_name, QVariant::fromValue(walletModel));
}

void QuarlcoinGUI::removeWallet(WalletModel* walletModel)
{
...
void QuarlcoinGUI::setCurrentWallet(WalletModel* wallet_model)
{
    if (!walletFrame || !m_wallet_controller) return;
...
void QuarlcoinGUI::setCurrentWalletBySelectorIndex(int index)
{
    WalletModel* wallet_model = m_wallet_selector->itemData(index).value<WalletModel*>();
    if (wallet_model) setCurrentWallet(wallet_model);
}

void QuarlcoinGUI::removeAllWallets()
{
    if(!walletFrame)
        return;
    setWalletActionsEnabled(false);
...
void QuarlcoinGUI::setWalletActionsEnabled(bool enabled)
{
...
void QuarlcoinGUI::createTrayIcon()
{
...
void QuarlcoinGUI::createTrayIconMenu()
{
#ifndef Q_OS_MACOS
    if (!trayIcon) return;
#endif // Q_OS_MACOS
    ...
    show_hide_action = trayIconMenu->addAction(QString(), this, &QuarlcoinGUI::toggleHidden);
...
void QuarlcoinGUI::optionsClicked()
{
    openOptionsDialogWithTab(OptionsDialog::TAB_MAIN);
}

void QuarlcoinGUI::aboutClicked()
{
    if(!clientModel)
        return;
...
void QuarlcoinGUI::showDebugWindow()
{
    GUIUtil::bringToFront(rpcConsole);
    Q_EMIT consoleShown(rpcConsole);
}

void QuarlcoinGUI::showDebugWindowActivateConsole()
{
    rpcConsole->setTabFocus(RPCConsole::TabTypes::CONSOLE);
    showDebugWindow();
}

void QuarlcoinGUI::showHelpMessageClicked()
{
    GUIUtil::bringToFront(helpMessageDialog);
}

#ifdef ENABLE_WALLET
void QuarlcoinGUI::openClicked()
{
...
void QuarlcoinGUI::gotoOverviewPage()
{
    overviewAction->setChecked(true);
    if (walletFrame) walletFrame->gotoOverviewPage();
}

void QuarlcoinGUI::gotoHistoryPage()
{
    historyAction->setChecked(true);
    if (walletFrame) walletFrame->gotoHistoryPage();
}

void QuarlcoinGUI::gotoReceiveCoinsPage()
{
    receiveCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoReceiveCoinsPage();
}

void QuarlcoinGUI::gotoSendCoinsPage(QString addr)
{
    sendCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoSendCoinsPage(addr);
}

void QuarlcoinGUI::gotoSignMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoSignMessageTab(addr);
}

void QuarlcoinGUI::gotoVerifyMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoVerifyMessageTab(addr);
}
void QuarlcoinGUI::gotoLoadPSBT(bool from_clipboard)
{
    if (walletFrame) walletFrame->gotoLoadPSBT(from_clipboard);
}
#endif // ENABLE_WALLET

void QuarlcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        tooltip = tr("%n active connection(s) to Quarlcoin network.", "", count);
    } else {
        //: A substring of the tooltip.
...
void QuarlcoinGUI::setNumConnections(int count)
{
    updateNetworkState();
}

void QuarlcoinGUI::setNetworkActive(bool network_active)
{
    updateNetworkState();
...
void QuarlcoinGUI::updateHeadersSyncProgressLabel()
{
...
void QuarlcoinGUI::updateHeadersPresyncProgressLabel(int64_t height, const QDateTime& blockDate)
{
...
void QuarlcoinGUI::openOptionsDialogWithTab(OptionsDialog::Tab tab)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;

    auto dlg = new OptionsDialog(this, enableWallet);
    connect(dlg, &OptionsDialog::quitOnReset, this, &QuarlcoinGUI::quitRequested);
...
void QuarlcoinGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, SyncType synctype, SynchronizationState sync_state)
{
...
void QuarlcoinGUI::createWallet()
{
#ifdef ENABLE_WALLET
    auto activity = new CreateWalletActivity(getWalletController(), this);
    connect(activity, &CreateWalletActivity::created, this, &QuarlcoinGUI::setCurrentWallet);
    connect(activity, &CreateWalletActivity::created, rpcConsole, &RPCConsole::setCurrentWallet);
    activity->create();
#endif // ENABLE_WALLET
}

void QuarlcoinGUI::message(const QString& title, QString message, unsigned int style, bool* ret, const QString& detailed_message)
{
...
void QuarlcoinGUI::changeEvent(QEvent *e)
{
    ...
    if(e->type() == QEvent::WindowStateChange)
    {
        if(clientModel && clientModel->getOptionsModel() && clientModel->getOptionsModel()->getMinimizeToTray())
        {
            ...
            {
                QTimer::singleShot(0, this, &QuarlcoinGUI::hide);
                e->ignore();
            }
            else if((wsevt->oldState() & Qt::WindowMinimized) && !isMinimized())
            {
                QTimer::singleShot(0, this, &QuarlcoinGUI::show);
                e->ignore();
            }
        }
    }
...
void QuarlcoinGUI::closeEvent(QCloseEvent *event)
{
#ifndef Q_OS_MACOS // Ignored on Mac
    if(clientModel && clientModel->getOptionsModel())
    {
...
void QuarlcoinGUI::showEvent(QShowEvent *event)
{
...
#ifdef ENABLE_WALLET
void QuarlcoinGUI::incomingTransaction(const QString& date, QuarlcoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName)
{
    // On new transaction, make an info balloon
    QString msg = tr("Date: %1\n").arg(date) +
                  tr("Amount: %1\n").arg(QuarlcoinUnits::formatWithUnit(unit, amount, true));
...
void QuarlcoinGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void QuarlcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
...
bool QuarlcoinGUI::eventFilter(QObject *object, QEvent *event)
{
...
#ifdef ENABLE_WALLET
bool QuarlcoinGUI::handlePaymentRequest(const SendCoinsRecipient& recipient)
{
    // URI has to be valid
...
void QuarlcoinGUI::setHDStatus(bool privkeyDisabled, int hdEnabled)
{
...
void QuarlcoinGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void QuarlcoinGUI::updateWalletStatus()
{
    assert(walletFrame);
...
void QuarlcoinGUI::updateProxyIcon()
{
    std::string ip_port;
...
void QuarlcoinGUI::updateWindowTitle()
{
...
void QuarlcoinGUI::showNormalIfMinimized(bool fToggleHidden)
{
    if(!clientModel)
        return;
...
void QuarlcoinGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void QuarlcoinGUI::detectShutdown()
{
...
void QuarlcoinGUI::showProgress(const QString &title, int nProgress)
{
    if (nProgress == 0) {
...
void QuarlcoinGUI::showModalOverlay()
{
    if (modalOverlay && (progressBar->isVisible() || modalOverlay->isLayerVisible()))
        modalOverlay->toggleVisibility();
}

[[nodiscard]] static bool ThreadSafeMessageBox(QuarlcoinGUI* gui, const bilingual_str& message, unsigned int style)
{
    ...
    if (message.original != message.translated) {
        detailed_message = QuarlcoinGUI::tr("Original message:") + "\n" + QString::fromStdString(message.original);
    }
...
void QuarlcoinGUI::subscribeToCoreSignals()
{
...
void QuarlcoinGUI::unsubscribeFromCoreSignals()
{
...
bool QuarlcoinGUI::isPrivacyModeActivated() const
{
    ...
    : m_platform_style{platformStyle}
{
    ...
    QList<QuarlcoinUnit> units = QuarlcoinUnits::availableUnits();
    int max_width = 0;
    const QFontMetrics fm(font());
    for (const QuarlcoinUnit unit : units) {
        max_width = qMax(max_width, GUIUtil::TextWidth(fm, QuarlcoinUnits::longName(unit)));
    }
...
{
    menu = new QMenu(this);
    for (const QuarlcoinUnit u : QuarlcoinUnits::availableUnits()) {
        menu->addAction(QuarlcoinUnits::longName(u))->setData(QVariant::fromValue(u));
    }
...
void UnitDisplayStatusBarControl::updateDisplayUnit(QuarlcoinUnit newUnits)
{
    setText(QuarlcoinUnits::longName(newUnits));
}
