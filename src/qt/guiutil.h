...
#ifndef QUARLCOIN_QT_GUIUTIL_H
#define QUARLCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Quarlcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "quarlcoin:" URI into recipient object, return true on successful parsing
