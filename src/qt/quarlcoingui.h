...
#ifndef QUARLCOIN_QT_QUARLCOINGUI_H
#define QUARLCOIN_QT_QUARLCOINGUI_H
...
/**
  Quarlcoin GUI main class. This class represents the main window of the Quarlcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class QuarlcoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit QuarlcoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~QuarlcoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a quarlcoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, QuarlcoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Quarlcoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(QuarlcoinUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // QUARLCOIN_QT_QUARLCOINGUI_H
