...
#ifndef QUARLCOIN_QT_OPTIONSMODEL_H
#define QUARLCOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Quarlcoin client.
...
public:
    ...
    QuarlcoinUnit getDisplayUnit() const { return m_display_quarlcoin_unit; }
...
private:
    ...
    QString language;
    QuarlcoinUnit m_display_quarlcoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(QuarlcoinUnit unit);
...
#endif // QUARLCOIN_QT_OPTIONSMODEL_H
