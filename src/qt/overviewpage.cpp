...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = QuarlcoinUnits::formatWithUnit(unit, amount, true, QuarlcoinUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
    ...
    QuarlcoinUnit unit{QuarlcoinUnit::QRL};
...
{
    QuarlcoinUnit unit = walletModel->getOptionsModel()->getDisplayUnit();
    ui->labelBalance->setText(QuarlcoinUnits::formatWithPrivacy(unit, balances.balance, QuarlcoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(QuarlcoinUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, QuarlcoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(QuarlcoinUnits::formatWithPrivacy(unit, balances.immature_balance, QuarlcoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(QuarlcoinUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, QuarlcoinUnits::SeparatorStyle::ALWAYS, m_privacy));
