      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->quarlcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->quarlcoinAtStartup);
    ...
    ui->quarlcoinAtStartup->setToolTip(ui->quarlcoinAtStartup->toolTip().arg(CLIENT_NAME));
    ui->quarlcoinAtStartup->setText(ui->quarlcoinAtStartup->text().arg(CLIENT_NAME));

    ui->openQuarlcoinConfButton->setToolTip(ui->openQuarlcoinConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new QuarlcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->quarlcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openQuarlcoinConfButton_clicked()
{
