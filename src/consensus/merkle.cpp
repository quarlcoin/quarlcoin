...
/*     WARNING! If you're reading this because you're learning about crypto
       ...
       merkle root. Assuming no SHA-256 collisions, this will detect all
...
uint256 ComputeMerkleRoot(std::vector<uint256> hashes, bool* mutated) {
    ...
    while (hashes.size() > 1) {
        ...
        // SHA256D64, which is not built here; fold each 64-byte pair with the
        // two-argument Hash() (= SHA-256d(left || right)) instead. Done in
