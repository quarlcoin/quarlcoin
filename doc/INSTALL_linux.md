...
Below are notes on installing Quarlcoin software on Linux systems.

General Runtime Requirements
----------------------------

Quarlcoin requires glibc (GNU C Library) 2.31 or newer.

GUI Runtime Requirements
------------------------

The GUI executable, `quarl-qt`, is based on the Qt 6 framework and uses the `xcb` QPA (Qt Platform Abstraction) platform plugin
