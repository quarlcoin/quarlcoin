...
Assumeutxo is a feature that allows fast bootstrapping of a validating quarld
instance.
...
```
$ quarl-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ quarl-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
