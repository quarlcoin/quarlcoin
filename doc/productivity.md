...
```sh
cmake --build build --target quarld quarl-cli
cmake --build build --target quarl-qt
cmake --build build --target bench_quarlcoin
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:quarlcoin/quarlcoin.git
```
...
> e.g. github.com/quarlcoin/quarlcoin.git or for the GUI github.com/quarlcoin-core/gui
