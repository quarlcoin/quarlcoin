...
This document provides guidelines for internationalization of the Quarlcoin software.
...
This can be checked by building the `translate` target with `cmake` ([instructions](translation_process.md)), then verifying that `quarlcoin_en.ts` remains unchanged.
