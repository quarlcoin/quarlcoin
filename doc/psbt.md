# PSBT Howto for Quarlcoin

Since Quarlcoin 0.17, an RPC interface exists for Partially Signed Quarlcoin
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/quarlcoin/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for Quarlcoin transactions that are not fully signed
...
#### Multisig with multiple Quarlcoin instances
