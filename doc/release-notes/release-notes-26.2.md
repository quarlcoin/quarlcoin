...
Quarlcoin version 26.2 is now available from:

  <https://quarlcoincore.org/bin/quarlcoin-core-26.2/>
...
using the Linux kernel, macOS 11.0+, and Windows 7 and newer.  Quarlcoin
