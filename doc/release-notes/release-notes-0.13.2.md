Quarlcoin version 0.13.2 is now available from:

  <https://quarlcoin.org/bin/quarlcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update quarl-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow quarl-tx to create v2 transactions (btcdrak)
