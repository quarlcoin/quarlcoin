Quarlcoin version 27.0 is now available from:

  <https://quarlcoincore.org/bin/quarlcoin-core-27.0/>
...
libquarlcoinconsensus
-------------------

- libquarlcoinconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libquarlcoinkernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build Quarlcoin. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Quarlcoin would
