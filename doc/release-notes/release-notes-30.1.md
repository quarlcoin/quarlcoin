...
Quarlcoin version v30.1 is now available from:

  <https://quarlcoincore.org/bin/quarlcoin-core-30.1/>
...
- #33229 multiprocess: Don't require quarlcoin -m argument when IPC options are used
