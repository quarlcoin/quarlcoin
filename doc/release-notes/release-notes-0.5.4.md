Quarlcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/quarlcoin/files/Quarlcoin/quarlcoin-0.5.4/
...
http://gitorious.org/quarlcoin/quarld-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Quarlcoin-Qt notifications under Growl 1.3.
Increase required age of Quarlcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxQuarlcoin properly when installing Quarlcoin-Qt over it. (Windows)
