Quarlcoin version 0.9.1 is now available from:

  https://quarlcoin.org/bin/0.9.1/
...
quarld from any pre-0.9.1 version, and have enabled SSL for RPC and
