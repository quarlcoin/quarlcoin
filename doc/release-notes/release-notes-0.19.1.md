...
Quarlcoin version 0.19.1 is now available from:

  <https://quarlcoincore.org/bin/quarlcoin-core-0.19.1/>
...
From Quarlcoin 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Quarlcoin is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Quarlcoin does not yet change appearance when
...
- #17488 fix "quarld already running" warnings on macOS (fanquake)
