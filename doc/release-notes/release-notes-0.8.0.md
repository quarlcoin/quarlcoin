Quarlcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/quarlcoin/files/Quarlcoin/quarlcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Quarlcoin
...
New/changed settings (command-line or quarlcoin.conf file)
--------------------------------------------------------
