Quarlcoin version 0.10.4 is now available from:

  <https://quarlcoin.org/bin/quarlcoin-core-0.10.4/>
...
- #6953 `43c2789` Split quarl-tx into its own package
- #6953 `dfe0d4d` Include quarl-tx binary on Debian/Ubuntu
