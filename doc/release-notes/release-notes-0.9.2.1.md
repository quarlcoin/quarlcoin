Quarlcoin version 0.9.2.1 is now available from:

  https://quarlcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 QRL to 0.01 QRL
...
- Fix "Start quarlcoin on system login"
