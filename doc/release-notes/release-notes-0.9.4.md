Quarlcoin version 0.9.4 is now available from:

  https://quarlcoin.org/bin/0.9.4/
...
this update is incompatible with the Quarlcoin system and could lead to consensus
forks.

Quarlcoin released binaries from https://quarlcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~quarlcoin/+archive/ubuntu/quarlcoin
- A third-party or self-compiled Quarlcoin

upgrade to Quarlcoin 0.9.4, which includes a workaround, **before** updating
OpenSSL.
