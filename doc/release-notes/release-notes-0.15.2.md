Quarlcoin version *0.15.2* is now available from:

  <https://quarlcoincore.org/bin/quarlcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in quarl-tx (TheBlueMatt)
