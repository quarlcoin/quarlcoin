Quarlcoin version 0.16.1 is now available from:

  <https://quarlcoincore.org/bin/quarlcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting quarld with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure quarld processes are cleaned up when tests end (sdaftuar)
